...
btn.onclick = (e) => {
  e.preventDefault()
  form.login.parentNode.style.border = '2px solid var(--black)'
  form.login.parentNode.parentNode.querySelector('small').textContent = ''
  form.login.parentNode.parentNode.querySelector('small').style.color = 'var(--black)'
  form.passwd.parentNode.style.border = '2px solid var(--black)'
  form.passwd.parentNode.parentNode.querySelector('small').textContent = ''
